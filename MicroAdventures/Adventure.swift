...
struct AdventureSamples {
    static let all: [Adventure] = [
        ...
        Adventure(
            ...
            title: "Berges de Seine Coffee Dash",
            description: "Do one short out-and-back along the Berges de Seine in Colombes, and turn back after 20 minutes.",
        ...
        Adventure(
            ...
            title: "Parc Caillebotte Morning Reset",
            description: "Set a 12-minute timer and do a short reset walk near Parc Caillebotte, then stop.",
        ...
        Adventure(
            ...
            title: "La Defense Riverbank Photo Trio",
            description: "Walk toward the La Defense riverbank and capture exactly three morning-light photos.",
        ...
        Adventure(
            ...
            title: "La Defense Steps Burst Circuit",
            description: "Do 4 rounds near La Defense: 90-second stair climb, 2-minute fast walk, then stop.",
