...
struct AdventureSamples {
    static let all: [Adventure] = [
        ...
        Adventure(
            ...
            title: "Seine Waterfront Sketch Stop",
            description: "Walk to the Seine bank near Pont de Bezons, sit for 15 minutes, and sketch or describe one thing you see.",
            decisionTags: ["low-energy", "afternoon", "outdoor", "waterside"],
            flavorTags: ["calm", "creative", "grounding"],
            category: .water,
            effort: .easy,
            recommendedEnergy: .low,
            bestTimeWindow: .afternoon,
            durationMinutes: 20,
            startPointName: "Pont de Bezons - Rive Gauche",
            endPointName: "Pont de Bezons - Rive Gauche",
            startLatitude: 48.9304,
            startLongitude: 2.2230,
            endLatitude: 48.9304,
            endLongitude: 2.2230,
            estimatedDistanceKm: 1.2,
            highlights: ["Still water views at low tide", "Sheltered bench spots along the bank"],
            tips: ["Bring a small notebook or use your phone notes", "Pick one object and describe it in three words"],
            locationName: "Pont de Bezons, Colombes",
            latitude: 48.9304,
            longitude: 2.2230,
            isCompleted: false
        ),
        Adventure(
            ...
            title: "Parc de Bezons Bird Count",
            description: "Walk through Parc de Bezons and count every distinct bird species you spot before reaching the far bench.",
            decisionTags: ["low-energy", "morning", "outdoor", "nature"],
            flavorTags: ["observation", "fresh-start", "grounding"],
            category: .nature,
            effort: .easy,
            recommendedEnergy: .low,
            bestTimeWindow: .morning,
            durationMinutes: 25,
            startPointName: "Parc de Bezons - Entree Principale",
            endPointName: "Parc de Bezons - Banc du Fond",
            startLatitude: 48.9328,
            startLongitude: 2.2177,
            endLatitude: 48.9341,
            endLongitude: 2.2199,
            estimatedDistanceKm: 1.5,
            highlights: ["Active birdlife in early hours", "Quiet tree-lined paths"],
            tips: ["Move slowly and pause every 50 m", "Count only birds you can identify by sight or sound"],
            locationName: "Parc de Bezons, Bezons",
            latitude: 48.9334,
            longitude: 2.2188,
            isCompleted: false
        ),
        Adventure(
            ...
            title: "Bois de Nanterre Power Walk",
            description: "Pick the longest straight path in Bois de Nanterre and walk it at your fastest pace four times.",
            decisionTags: ["high-energy", "morning", "outdoor", "walkable"],
            flavorTags: ["challenge", "energising", "reset"],
            category: .nature,
            effort: .hard,
            recommendedEnergy: .high,
            bestTimeWindow: .morning,
            durationMinutes: 40,
            startPointName: "Bois de Nanterre - Entree Ouest",
            endPointName: "Bois de Nanterre - Clairiere Centrale",
            startLatitude: 48.9048,
            startLongitude: 2.2108,
            endLatitude: 48.9071,
            endLongitude: 2.2152,
            estimatedDistanceKm: 4.0,
            highlights: ["Shaded forest paths away from traffic", "Clear straight stretch ideal for tempo walking"],
            tips: ["Drink water before you start", "Use the first lap as a warm-up at a slower pace"],
            locationName: "Bois de Nanterre, Nanterre",
            latitude: 48.9059,
            longitude: 2.2130,
            isCompleted: false
        ),
        Adventure(
            ...
            title: "La Defense Grid Walk",
            description: "Walk one geometric grid block at La Defense, pause at each corner for 30 seconds, then head back.",
            decisionTags: ["medium-energy", "afternoon", "outdoor", "urban-explore"],
            ...
            bestTimeWindow: .afternoon,
            durationMinutes: 35,
            startPointName: "Grande Arche de la Defense",
            endPointName: "Parvis de la Defense - Fontaines",
            startLatitude: 48.8921,
            startLongitude: 2.2360,
            endLatitude: 48.8906,
            endLongitude: 2.2418,
            estimatedDistanceKm: 2.8,
            highlights: ["Striking modernist architecture at every turn", "Open esplanade with wide sightlines"],
            tips: ["Look up at the towers as well as at ground level", "Avoid rush-hour crowds (12:00–14:00)"],
            locationName: "La Defense, Nanterre",
            latitude: 48.8913,
            longitude: 2.2389,
            isCompleted: false
        ),
        Adventure(
            ...
            title: "Colombes Family Colour Hunt",
            description: "Walk one block around Colombes centre with a child and find one object of each colour in the rainbow before returning.",
            decisionTags: ["low-energy", "afternoon", "outdoor", "family"],
            flavorTags: ["playful", "quick-win", "connection"],
            category: .family,
            effort: .easy,
            recommendedEnergy: .low,
            bestTimeWindow: .afternoon,
            durationMinutes: 20,
            startPointName: "Place de la Republique, Colombes",
            endPointName: "Place de la Republique, Colombes",
            startLatitude: 48.9243,
            startLongitude: 2.2558,
            endLatitude: 48.9243,
            endLongitude: 2.2558,
            estimatedDistanceKm: 1.0,
            highlights: ["Simple game any age can play", "Turns an ordinary street into a treasure hunt"],
            tips: ["Print or draw a colour checklist before you go", "Stop the moment you find all seven colours"],
            locationName: "Centre-ville de Colombes",
            latitude: 48.9243,
            longitude: 2.2558,
            isCompleted: false
        ...
        Adventure(
            ...
            title: "Pont de Bezons Sunrise Stop",
            description: "Reach Pont de Bezons before sunrise, watch the light change for exactly 10 minutes, then walk back.",
            decisionTags: ["medium-energy", "morning", "outdoor", "waterside"],
            flavorTags: ["fresh-start", "grounding", "visual"],
            category: .nature,
            effort: .moderate,
            recommendedEnergy: .medium,
            bestTimeWindow: .morning,
            durationMinutes: 15,
            startPointName: "Pont de Bezons - Centre",
            endPointName: "Pont de Bezons - Centre",
            startLatitude: 48.9308,
            startLongitude: 2.2218,
            endLatitude: 48.9308,
            endLongitude: 2.2218,
            estimatedDistanceKm: 1.0,
            highlights: ["Wide unobstructed view east over the Seine", "Reflections of early light on the water"],
            tips: ["Check sunrise time the night before", "Bring a warm drink in a flask"],
            locationName: "Pont de Bezons, Colombes",
            latitude: 48.9308,
            longitude: 2.2218,
            isCompleted: false
        ...
        Adventure(
            ...
            title: "Seine Edge Evening Dip",
            description: "Walk to the legal bathing bank on the Seine at Colombes, wade in up to your knees, then dry off and leave.",
            decisionTags: ["medium-energy", "evening", "outdoor", "waterside"],
            flavorTags: ["refresh", "sensory", "reset"],
            category: .water,
            effort: .moderate,
            recommendedEnergy: .medium,
            bestTimeWindow: .evening,
            durationMinutes: 30,
            startPointName: "Berges de Seine - Acces Baignade",
            endPointName: "Berges de Seine - Acces Baignade",
            startLatitude: 48.9255,
            startLongitude: 2.2388,
            endLatitude: 48.9255,
            endLongitude: 2.2388,
            estimatedDistanceKm: 1.8,
            highlights: ["Cool water contrast after a warm day", "Quiet riverbank atmosphere at dusk"],
            tips: ["Check water quality notices before going", "Bring a small towel and flip-flops"],
            locationName: "Berges de Seine, Colombes",
            latitude: 48.9255,
            longitude: 2.2388,
            isCompleted: false
        ...
        Adventure(
            id: UUID(uuidString: "B8C9D0E1-F2A3-4567-BCDE-678901234567")!,
            title: "Colombes Night Sound Walk",
            description: "Walk a 15-minute loop near your home in Colombes with no music and count every distinct sound you hear.",
            decisionTags: ["low-energy", "night", "walkable", "mindful"],
            flavorTags: ["quiet", "sensory", "reset"],
            category: .night,
            effort: .easy,
            recommendedEnergy: .low,
            bestTimeWindow: .night,
            durationMinutes: 25,
            startPointName: "Depart Maison - Colombes",
            endPointName: "Depart Maison - Colombes",
            startLatitude: 48.9260,
            startLongitude: 2.2600,
            endLatitude: 48.9260,
            endLongitude: 2.2600,
            estimatedDistanceKm: 1.3,
            highlights: ["Night quiet reveals sounds hidden in daytime", "Simple mindfulness with zero equipment"],
            tips: ["Leave headphones at home", "Note the three most surprising sounds after you return"],
            locationName: "Quartier Residentiel, Colombes",
            latitude: 48.9260,
            longitude: 2.2600,
            isCompleted: false
        )
